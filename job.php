...
// Query to count jobs for each category
$sql = "SELECT job_category, COUNT(*) AS job_count FROM jobs GROUP BY job_category";
$result = $conn->query($sql);




// Array to store job counts by category
$job_counts = [];
...
if ($result->num_rows > 0)
 {
    while ($row = $result->fetch_assoc())
     {
        // Store the category and its corresponding job count
        $job_counts[$row['job_category']] = $row['job_count'];
    }
}

// Now $job_counts contains an associative array with categories as keys and job counts as values
...
$icons = [
    'design and creative' => 'flaticon-tour',
    'data_science' => 'flaticon-cms',
    'human_resources' => 'flaticon-report',
    'software_engineering' => 'flaticon-app',
   ...
   <body>
    ...
    <main>
                ...
                <div class="container">
                    ...
                    <div class="row d-flex justify-content-center">
                        <?php if (!empty($job_counts)): ?>
                            <?php foreach ($job_counts as $category => $count): ?>
                                <?php if ($count > 0): ?>
        ...
        <!-- Featured_job_start -->
            ...
            // Function to format posted time (e.g., '7 hours ago')
